...
customer1.set_first_name("Ramu")
customer1.set_last_name("Prasad")
customer1.set_email("ramuprasad@gmail.com")
customer1.set_phone_number("9876543210")
customer1.set_address("123 Indore, India")


# customer1.print_all_info()
